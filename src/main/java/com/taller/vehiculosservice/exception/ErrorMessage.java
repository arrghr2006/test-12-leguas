...
public class ErrorMessage {
    public static final String DUPLICATED_VEHICLE = "La matrícula o el vin especificado ya estan asociados a otro vehículo.";
    ...
    public static final String RECONVERSION_ERROR = "Debe especificar la matrícula y tipo de combustible después de la reconversión;";
